...
# Resize the background image to match the dimensions of the game window
background_img = pygame.transform.scale(background_img, (dis_width, dis_height))

def my_score(score):
    value = score_font.render("Score: "+str(score),True,yellow)
    dis.blit(value, [100,10])
...
def main_game():
    ...
    while not game_over:
        ...
        x1 += x1_change
        y1 += y1_change
        dis.blit(background_img, (0, 0))  # Blit the background image onto the game window
